...
#Parameter estimates will be bit unconverged for small datasets but the ICM algorithm convergence is 
#- determined by the convergence of estimated DE states.
